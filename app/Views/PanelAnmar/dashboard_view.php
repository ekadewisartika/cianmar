...
<main class="p-8 sm:ml-64">
        ...
        <div class="card bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-all">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800"><?= $data['paket_count'] ?></h3>
                </div>
            </div>
        </div>
        <div class="card bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-all">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800"><?= $data['active_count'] ?></h3>
                </div>
            </div>
        </div>
        <div class="card bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-all">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800"><?= $data['inactive_count'] ?></h3>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="<?= base_url('admin/paket/create') ?>" class="quick-action-card bg-white rounded-xl shadow-sm p-4 flex items-center justify-between hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center">
            ...
            <a href="<?= base_url('admin/pengaturan') ?>" class="quick-action-card bg-white rounded-xl shadow-sm p-4 flex items-center justify-between hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center">
                    <div class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
